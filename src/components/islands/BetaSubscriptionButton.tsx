...
const translationsMap: Record<Locale, Record<string, string>> = {
    uk: {
        ...
        beta_already_desc: "Ви вже в списку! Плануємо відкрити ранній доступ на початку травня. Перевірте папку «Спам», якщо лист із підтвердженням не прийшов.",
    ...
    en: {
        ...
        beta_already_desc: "You're already on the list! Early access is planned for early May. Don't forget to check your spam folder if our confirmation email didn't arrive.",
    ...
    return (
        <>
            <button
                ...
                className={`btn-gradient-border bg-[#1C4FD8] hover:bg-[#1946BF] active:bg-[#143899] text-white font-['Mulish'] font-semibold text-[16px] leading-[150%] text-center py-4 px-8 md:py-[20px] md:px-[40px] rounded-[12px] md:rounded-[16px] transition-all shadow-sm active:scale-[0.98] focus:outline-none flex items-center justify-center gap-4 inline-flex ${className}`}
