...
const translationsMap: Record<Locale, Record<string, string>> = {
    ...
    en: {
        ...
        beta_already_desc: "You've already signed up for the beta test. Check your email for instructions and next steps. Don't forget to check your spam folder too!",
